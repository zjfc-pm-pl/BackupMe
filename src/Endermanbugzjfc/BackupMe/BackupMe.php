...
final class BackupMe extends \pocketmine\plugin\PluginBase {
	...
	public function onEnable() : void {
		...
		$checker = (new BackupMeFileCheckTask($this));
	...
	private function initConfig() : bool {
		...
		$conf->set('ignore-disk-space', (int)($all['ignore-disk-space'] ?? false));
	...
	private function getSafeServerDataPath() : string {
		return dirname($this->getDataFolder(), 2) . DIRECTORY_SEPERATOR;
	}
}
